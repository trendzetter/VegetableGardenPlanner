(function () {
  ...
  describe('Admin Friends List Controller Tests', function () {
    // Initialize global variables
    var FriendsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _FriendsService_) {
      ...
      $httpBackend.whenGET('/modules/friends/client/views/list-friends.client.view.html').respond(200, '');
      ...
      FriendsAdminListController = $controller('FriendsAdminListController as vm', {
        $scope: $scope
      });
