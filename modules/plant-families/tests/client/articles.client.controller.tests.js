(function () {
  ...
  describe('PlantFamilies Controller Tests', function () {
    // Initialize global variables
    var PlantFamiliesController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _PlantFamilyService_) {
      ...
      // create mock article
      mockArticle = new PlantFamilyService({
      ...
      PlantFamiliesController = $controller('PlantFamiliesController as vm', {
        $scope: $scope,
        articleResolve: {}
      });
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleArticlePostData = new PlantFamilyService({
          title: 'An Article about MEAN',
          content: 'MEAN rocks!'
        });
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (PlantFamilyService) {
        // Set POST response
    ...
    describe('vm.save() as update', function () {
      ...
      it('should update a valid article', inject(function (PlantFamilyService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (PlantFamilyService) {
