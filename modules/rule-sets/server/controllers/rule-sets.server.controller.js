...
exports.list = function(req, res) {
  RuleSet.find().sort('-created').populate('user', 'displayName').exec(function(err, ruleSets) {
    if (err) {
      return res.send(400, {
        message: getErrorMessage(err)
      });
...
exports.ruleSetByID = function(req, res, next, id) {
  RuleSet.findById(id).populate('user', 'displayName').populate('rotationrules').exec(function(err, ruleSet) {
