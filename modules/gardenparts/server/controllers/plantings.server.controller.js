...
exports.delete = function(req, res) {
    ...
    Planting.remove({_id: {'$in': plantingids}},function(){
...
exports.gardenByBK = function(req, res, next, gardenbk) {
    Garden.findOne({validFrom: {$lte: req.params.selectedDate}, bk: gardenbk}).populate('user', 'displayName').sort('-validFrom').exec(function(err, garden) {
