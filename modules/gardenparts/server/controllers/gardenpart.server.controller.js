            ...
            {garden: req.gardenpart.garden},
             ...
             { $or: [
                //Is rightTopCorner in gardenpart?
                 ...
                 {$and: [{'rightCornerLeft' : { $gt: req.gardenpart.elemleft}}, {'rightCornerLeft': {$lt: rightCornerLeft }},{'elemtop' : { $gte: req.gardenpart.elemtop}}, {'elemtop': {$lt: bottomCornerTop }}]},
                 ...
                 {$and: [{'rightCornerLeft' : { $gt: req.gardenpart.elemleft}}, {'rightCornerLeft': {$lt: rightCornerLeft }},{'bottomCornerTop' : { $gte: req.gardenpart.elemtop}}, {'bottomCornerTop': {$lt: bottomCornerTop }}]}
             ]}
         ]},
