...
!function(){"use strict";function menuConfig(menuService){menuService.addSubMenuItem("topbar","system",{title:"Lijst teelwijzen",state:"cultivation-plans.list"}),menuService.addSubMenuItem("topbar","system",{title:"Teelwijze toevoegen",state:"cultivation-plans.create",roles:["user"]})}angular.module("cultivation-plans").run(menuConfig),menuConfig.$inject=["menuService"]}();
...
!function(){"use strict";function menuConfig(Menus){Menus.addMenuItem("topbar",{title:"Moestuin",state:"gardens",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","gardens",{title:"Lijst moestuinen",state:"listGardens"}),Menus.addSubMenuItem("topbar","gardens",{title:"Moestuin creëren",state:"createGarden",roles:["user"]})}angular.module("gardens").run(menuConfig),menuConfig.$inject=["menuService"]}();
...
!function(){"use strict";function menuConfig(Menus){Menus.addSubMenuItem("topbar","system",{title:"Lijst planten families",state:"plantfamilies.list"}),Menus.addSubMenuItem("topbar","system",{title:"Plant familie toevoegen",state:"plantfamilies.create",roles:["user"]})}angular.module("plantfamilies").run(menuConfig),menuConfig.$inject=["menuService"]}();
...
!function(){"use strict";function menuConfig(Menus){Menus.addMenuItem("topbar",{title:"Plant varieteiten",state:"plant-varieties",type:"dropdown",roles:["*"]}),Menus.addSubMenuItem("topbar","plant-varieties",{title:"Lijst varieteiten",state:"plant-varieties.list"}),Menus.addSubMenuItem("topbar","plant-varieties",{title:"Variëteit toevoegen",state:"plant-varieties.create",roles:["user"]})}angular.module("plant-varieties").run(menuConfig),menuConfig.$inject=["menuService"]}();
...
!function(){"use strict";function menuConfig(menuService){menuService.addSubMenuItem("topbar","system",{title:"Lijst rotatieschema's",state:"rulesets.list"}),menuService.addSubMenuItem("topbar","system",{title:"Rotatieschema creëren",state:"rulesets.create",roles:["user"]})}angular.module("rule-sets").run(menuConfig),menuConfig.$inject=["menuService"]}();
...
!function(){"use strict";function menuConfig(Menus){Menus.addSubMenuItem("topbar","system",{title:"Manage Tasks",state:"admin.tasks.list"})}angular.module("tasks.admin").run(menuConfig),menuConfig.$inject=["menuService"]}();
...
!function(){"use strict";function menuConfig(menuService){menuService.addMenuItem("topbar",{title:"Tasks",state:"tasks",type:"dropdown",roles:["user"]}),menuService.addSubMenuItem("topbar","tasks",{title:"List Tasks",state:"tasks.list",roles:["user"]})}angular.module("tasks").run(menuConfig),menuConfig.$inject=["menuService"]}();
