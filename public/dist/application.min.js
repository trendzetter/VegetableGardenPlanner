...
!function(){"use strict";function menuConfig(menuService){menuService.addMenuItem("topbar",{title:"Rule sets",state:"rulesets",type:"dropdown",roles:["*"]}),menuService.addSubMenuItem("topbar","rulesets",{title:"List rule sets",state:"rulesets.list"}),menuService.addSubMenuItem("topbar","rulesets",{title:"Create rule set",state:"rulesets.create",roles:["user"]})}angular.module("rule-sets").run(menuConfig),menuConfig.$inject=["menuService"]}();
