!function(window){"use strict";function registerModule(moduleName,dependencies){angular.module(moduleName,dependencies||[]),angular.module(applicationModuleName).requires.push(moduleName)}var applicationModuleName="mean",service={applicationModuleName:applicationModuleName,applicationModuleVendorDependencies:["ngResource","ngAnimate","ngMessages","ui.router","ui.bootstrap","ui.bootstrap.contextMenu","angularFileUpload","dragon-drop","ngCropper"],registerModule:registerModule};window.ApplicationConfiguration=service}(window);
...
!function(app){"use strict";app.registerModule("articles",["core"]),app.registerModule("articles.services"),app.registerModule("articles.routes",["ui.router","core.routes","articles.services"])}(ApplicationConfiguration);
...
!function(){"use strict";function CultivationPlansService($resource){return $resource("api/cultivation-plans/:cultivationPlanId",{cultivationPlanId:"@_id"},{update:{method:"PUT"}})}angular.module("cultivation-plans.services").factory("CultivationPlansService",CultivationPlansService),CultivationPlansService.$inject=["$resource"]}();
